...
func (mr *MockHerokuClientMockRecorder) ConfigVarInfoForApp(ctx, appIdentity any) *gomock.Call {
...
func (mr *MockHerokuClientMockRecorder) ConfigVarUpdate(ctx, appIdentity, o any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
