...
func (mr *MockGopassClientMockRecorder) Get(ctx, name, revision any) *gomock.Call {
...
func (mr *MockGopassClientMockRecorder) List(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGopassClientMockRecorder) Set(ctx, name, sec any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
