...
func (mr *MockAzureKeyVaultClientMockRecorder) DeleteSecret(ctx, vaultBaseURL, secretName any) *gomock.Call {
...
func (mr *MockAzureKeyVaultClientMockRecorder) GetSecret(ctx, vaultBaseURL, secretName, secretVersion any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAzureKeyVaultClientMockRecorder) GetSecrets(ctx, vaultBaseURL, maxresults any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAzureKeyVaultClientMockRecorder) SetSecret(ctx, vaultBaseURL, secretName, parameters any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
