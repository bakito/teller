...
func (mr *MockGitHubActionClientMockRecorder) CreateOrUpdateRepoSecret(ctx, owner, repo, eSecret any) *gomock.Call {
...
func (mr *MockGitHubActionClientMockRecorder) DeleteRepoSecret(ctx, owner, repo, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGitHubActionClientMockRecorder) GetRepoPublicKey(ctx, owner, repo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGitHubActionClientMockRecorder) ListRepoSecrets(ctx, owner, repo, opts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
