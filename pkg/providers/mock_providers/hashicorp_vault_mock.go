...
func (mr *MockHashicorpClientMockRecorder) Read(path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Read", reflect.TypeOf((*MockHashicorpClient)(nil).Read), path)
}

// Write mocks base method.
func (m *MockHashicorpClient) Write(path string, data map[string]any) (*api.Secret, error) {
	m.ctrl.T.Helper()
...
func (mr *MockHashicorpClientMockRecorder) Write(path, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
