...
func (mr *MockOnePasswordClientMockRecorder) GetItemByTitle(title, vaultUUID any) *gomock.Call {
...
func (mr *MockOnePasswordClientMockRecorder) UpdateItem(item, vaultUUID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
